...
pub fn test_constants(expected: &[Object], actual: &[Rc<Object>]) {
...
fn test_instructions(expected: &[Instructions], actual: &Instructions) {
    let expected_ins = concat_instructions(expected.to_owned());
